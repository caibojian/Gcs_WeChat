...
public class CaptchaFormAuthenticationFilter extends BaseFormAuthenticationFilter {
	...
	protected String getQRcontent(ServletRequest request) {
		return WebUtils.getCleanParam(request, "QRcontent");
	}
