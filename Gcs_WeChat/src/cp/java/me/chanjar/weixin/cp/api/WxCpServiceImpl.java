...
public class WxCpServiceImpl implements WxCpService {
  ...
  public void messageSendMp(WxMpMessage message) throws WxErrorException {
	    String url = "https://qyapi.weixin.qq.com/cgi-bin/message/send";
	    post(url, message.toJsonMP());
	  }
...
@Override
public String[] oauth2getUserInfo(String agentId, String code)
		throws WxErrorException {
	// TODO Auto-generated method stub
	return null;
}
