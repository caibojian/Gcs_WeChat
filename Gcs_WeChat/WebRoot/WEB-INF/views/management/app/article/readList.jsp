...
<!-- 下拉树模块 -->
	...
	<gcs:layoutDiv options="region:'center',split:true"	style="width:100%;height:100%;" title="阅读人列表">
		<gcs:dataGrid id="gcs_dg" style="width:100%;height:150px;"
			options="url:'${contextPath}/management/article/readListData?titleId=${titleId }',onResize:changeSize,pageSize:20,border:false,singleSelect:true,autoRowHeight:false,fit:true,pagination:true,toolbar: '#tb'">
			<thead>
				<tr>
					<th data-options="field:'userName',width:240,formatter:addTitle,align:'center'">姓名</th>
					<th data-options="field:'orgStr',width:240,align:'center',formatter:addTitle">单位</th>
					<th data-options="field:'createTimeStr',width:240,formatter:addTitle,align:'center'">阅读时间</th>
