...
<html lang="zh-CN">
						...
						<div style="padding: 10px 0 10px 10px">
							<table border="0">
								<tr height="35px" width="99%">
									...
									<td>
										<input class="easyui-validatebox" type="text" name="description" id="description"
												...
												<div class="appmsg multi editing">
													<div class="appmsg_content" id="js_appmsg_preview">
														...
														<div class="appmsg_item js_appmsg_item " data-id="2" data-fileid="" id="appmsgItem2">
															...
															<div class="appmsg_edit_mask">
																<a href="javascript:void(0);" onclick="return false;" data-id="2" class="icon18_common edit_gray js_edit">查看</a>
  	...
  	function submitForm(){
		...
		function refreshView(){
			$.ajax({    	
				type:"get", 
				async : false,
			    url:'${contextPath}/management/msg/refreshView',
				success:function(data){
					var html = '';
					for (var m in data.msg) {
						if(m=='0'){
							
							html = html+"<div class='js_appmsg_item' data-id='1' data-fileid=''	id='appmsgItem1'>"+
							"<div class='appmsg_info'>"+
								"<em class='appmsg_date'></em>"+
							"</div>"+
							"<div class='cover_appmsg_item'>"+
								"<h4 class='appmsg_title' id='appmsg_title1'>"+
									"<a target='_blank' onclick='return false;' href='javascript:void(0);'>标题:"+data.msg[m].title+"</a>"+
								"</h4>"+
								"<div class='appmsg_thumb_wrp'>"+
									"<img src="+data.msg[m].picUrl+"  >"+ 
								"</div>"+
								"<div class='appmsg_edit_mask'>"+
									"<a href='javascript:void(0);' onclick='showMsg(\""+data.msg[m].id+"\");' data-id='1' class='icon18_common edit_gray js_edit'>查看</a>"+
									"<a href='javascript:void(0);' onclick='clearForm(\""+data.msg[m].id+"\");' data-id='2' class='icon18_common del_gray js_del'>删除</a>"+
								"</div>"+
							"</div>"+
						"</div>";
						}else{
							html = html +"<div class='appmsg_item js_appmsg_item ' data-id='2' data-fileid='' id='appmsgItem2'>"+
							"<img src="+data.msg[m].picUrl+" id='appmsg_thumb2' class='appmsg_thumb default'>" +
							"<h4 class='appmsg_title' id='appmsg_title2'>"+
								"<a target='_blank' href='javascript:void(0);' onclick='return false;'>标题:"+data.msg[m].title+"</a>"+
							"</h4>"+
							"<div class='appmsg_edit_mask'>"+
								"<a href='javascript:void(0);' onclick='showMsg(\""+data.msg[m].id+"\");' data-id='2' class='icon18_common edit_gray js_edit'>查看</a>"+
								"<a href='javascript:void(0);' onclick='clearForm(\""+data.msg[m].id+"\");' data-id='2' class='icon18_common del_gray js_del'>删除</a>"+
							"</div>"+
						"</div>";
						}
					}
					$("#js_appmsg_preview").html(html);
	...
	function showMsg(id) {
			if(id){
				var url = '${contextPath}/management/msg/showTempMsg?id='+id;
