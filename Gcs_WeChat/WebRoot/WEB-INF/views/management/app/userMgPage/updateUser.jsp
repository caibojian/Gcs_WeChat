...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>组织管理</title>
		<meta name="description" content="人员信息修改" />
	...
	<div class="" id="content" style="width:500px">
		...
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="${contextPath}/management/userMg/updateWechatUser" method="post"> 
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" id="name" name="name"  class="col-xs-5 col-sm-5" value="${user.name }">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" id="policeID" name="policeID"  class="col-xs-5 col-sm-5" value="${user.policeID }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<select class="easyui-combotree col-xs-5 col-sm-5" data-options="url:'${contextPath}/management/organizationMG/treeData',method:'post',valueField:'id',textField:'text',panelHeight:'300',required:true,value:'${user.department }'" name="department" id="department" >
							</select>
						</div>
						<div class="space-2"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" id="mobile" name="mobile"  class="col-xs-5 col-sm-5" value="${user.mobile }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" class="col-xs-5 col-sm-5" id="email" name="email" value="${user.email }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input class="col-xs-5 col-sm-5" type="text" id="weixinid" name="weixinid" value="${user.weixinid }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" class="col-xs-5 col-sm-5" id="position" name="position" value="${user.position }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" class="col-xs-5 col-sm-5" id="form-input-readonly" id="policeRank" name="policeRank" value="${user.policeRank }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" class="col-xs-5 col-sm-5" id="policeType" name="policeType" value="${user.policeType }">
						</div>
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input id="policeAge" name="policeAge" 
								class="easyui-datebox col-xs-5 col-sm-5" value="${user.dateStr }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="radio" id="mjxb" name="mjxb" value="0">&nbsp;&nbsp;&nbsp;男&nbsp;&nbsp;&nbsp;
							<input type="radio" id="mjxb" name="mjxb" value="1">&nbsp;&nbsp;&nbsp;女
						</div>
