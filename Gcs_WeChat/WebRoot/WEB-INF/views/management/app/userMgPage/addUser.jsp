	...
	<div class="" style="width:500px;">
		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal"
				action="${contextPath}/management/userMg/addWechatUser"
				method="post">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" id="name" name="name"
								class="col-xs-5 col-sm-5" value="${user.name }">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" id="policeID" name="policeID"
								class="col-xs-5 col-sm-5" value="${user.policeID }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<c:if test="${!empty user}">
   							<input type="text" id="departmentstr" name="departmentstr"
								class="col-xs-5 col-sm-10" value="${user.departmentstr }" readonly="true">
							<input type="hidden" id="department" name="department"
								class="col-xs-5 col-sm-5" value="${ user.department}">
						</c:if>
						<c:if test="${empty user}">
							<input type="text" id="departmentstr" name="departmentstr"
								class="col-xs-5 col-sm-10" value="${org.name }" readonly="true">
							<input type="hidden" id="department" name="department"
								class="col-xs-5 col-sm-5" value="${ org.id}">
						</c:if>
						</div>
					...
					<div class="col-sm-9">
						<div class="clearfix" >
							<input type="text" id="mobile" name="mobile"
								class="col-xs-5 col-sm-5" value="${user.mobile }">
						</div>

						<div id="mobileTip" class="space-2"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" class="col-xs-5 col-sm-5" id="email"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input class="col-xs-5 col-sm-5" type="text" id="weixinid"
								name="weixinid" value="${user.weixinid }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" class="col-xs-5 col-sm-5" id="position"
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" class="col-xs-5 col-sm-5"
								id="form-input-readonly" id="policeRank" name="policeRank" value="${user.policeRank }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input type="text" class="col-xs-5 col-sm-5" id="policeType"
								name="policeType" value="${user.policeType }">
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input id="agentTag" name="agentTag" class="easyui-combotree" data-options="url:'${contextPath}/management/agent/getTagData',method:'post',cascadeCheck:true,required:true" multiple />
						</div>
