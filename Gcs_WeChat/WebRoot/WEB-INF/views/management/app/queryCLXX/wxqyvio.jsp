...
<div class="">
  ...
  <h1 class="title">武汉交管局-车辆违章信息查询</h1> 
  </header>
<form class="input-group" style="padding-top:50px" action="${contextPath}/management/wechat/clwzData" method="post">
  <div class="input-row">
    <label>车辆类型:</label>
    <input type="text" id="car_dummy" class="" placeholder="" readonly="" name="car_dummy">
